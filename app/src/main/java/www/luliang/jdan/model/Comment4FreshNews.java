...
import www.luliang.jdan.view.floorview.Commentable;
...
public class Comment4FreshNews extends Commentator implements Comparable, Commentable {
	...
	//评论列表
	public static final String URL_COMMENTS     = "http://jandan" + "" +
			".net/?oxwlxojflwblxbsapi=get_post&include=comments&id=";
	//对新鲜事发表评论
